<template>
  ...
  <div class="home-menu">
    <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" fill="currentColor" class="bi bi-cup-hot-fill" viewBox="0 0 16 16" style="margin-bottom: 40px">
    ...
    <div class="card mx-auto mt-4" style="width: 25rem;">
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item">Ajouter un joueur</li>
        <li class="list-group-item">Panthéon</li>
      </ul>
    </div>
